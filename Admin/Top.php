...
<body>
    ...
    <main id="main-wrapper" class="main-wrapper">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                                <div class="px-4 pb-0 pt-2">
                                    <div class="lh-1 ">
                                        ...
                                        <a data-bs-toggle='modal' data-bs-target='#ChangeProfile' href="#" class="text-inherit fs-6">View my profile</a>
                                    </div>
        ...
        <div class="navbar-vertical navbar nav-dashboard">
            <div class="h-100" data-simplebar>
                ...
                <ul class="navbar-nav flex-column" id="sideNavbar">
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link has-arrow " href="Course.php">
                            <i class='fa fa-bullhorn'></i>&nbsp;&nbsp;Courses
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link has-arrow " href="Colleges.php">
                            <i class='fa fa-phone-square'></i>&nbsp;&nbsp;Colleges
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link has-arrow " href="Intern.php">
                            <i class='fa fa-user-graduate'></i>&nbsp;&nbsp;Intern
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link has-arrow " href="Company.php">
                            <i class='fa fa-industry'></i>&nbsp;&nbsp;Companies
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link has-arrow " href="Feedback.php">
        ...
        if (isset($_POST["btnChangePass"]))
        {
            ...
            $Id = $_SESSION["AdminId"];
            $Query = "select * from  adminmaster where AdminId=$Id and Password='$oldPasswd'";
            $res = mysqli_query($Con, $Query);
            if ($row = mysqli_fetch_assoc($res))
            {
                $Query  = "Update adminmaster set Password = '$newPasswd' where AdminId=$Id";
...
<?php
    $Query = "select * from adminmaster where AdminId = ".$_SESSION["AdminId"];
    $res = mysqli_query($Con, $Query);
...
<div class="modal fade" id="ChangeProfile" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #343a40;">
                <h4 class="modal-title text-white">Change Profile</h4>
            </div>
            <div class="modal-body">
                <form method='post' id="ChangePasswordForm">
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <b>Full Name</b><span id="lblProfileName" style="color:red">*</span>
                            <input type="text" value='<?php echo $row["FullName"]; ?>' name="txtProfileName" class="form-control" id="txtProfileName"
                                placeholder="Full Name" />
                        </div>
                        <div class="col-md-12 mb-2">
                            <b>Contact No</b><span id="lblContactNo" style="color:red">*</span>
                            <input type="text" value='<?php echo $row["ContactNo"]; ?>' name="txtContactNo" id="txtContactNo" class="form-control"
                                placeholder="Contact No" />
                        </div>
                        <div class="col-md-12 mb-2">
                            <b>Email</b><span id="lblEmail" style="color:red">*</span>
                            <input type="text" value='<?php echo $row["Email"]; ?>' name="txtEmail" id="txtEmail"
                                class="form-control" placeholder="Email" />
                        </div>
                        <div class="col-md-12 mb-2">
                            <b>UserName</b><span id="lblUser" style="color:red">*</span>
                            <input type="text" value='<?php echo $row["UserName"]; ?>' name="txtUser" id="txtUser"
                                class="form-control" placeholder="UserName" />
                        </div>
                        <div class="col-md-12 mb-2">
                            <button style='width: 200px;' type="submit" class="btn btn-primary"
                                id="btnChangeProfile" name="btnChangeProfile">Save</button>
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </form>
...
<?php
    ...
    {
        $FullName = $_POST["txtProfileName"];
        $ContactNo = $_POST["txtContactNo"];
        $UserName = $_POST["txtUser"];
        $Email = $_POST["txtEmail"];
        $AdminId = $_SESSION["AdminId"];
        $Query = "UPDATE `adminmaster` SET `FullName` = '$FullName', `ContactNo` = '$ContactNo', `Email` = '$Email', 
                                           `UserName` = '$UserName' WHERE `adminmaster`.`AdminId` = $AdminId";
        mysqli_query($Con, $Query);
        $_SESSION["FullName"] = $_POST["txtProfileName"];
?>
        <script>
