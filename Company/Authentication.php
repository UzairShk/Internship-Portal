...
<body>
                ...
                <div class="card smooth-shadow-md">
                    ...
                    <div class="card-body p-6">
                        <div class="mb-4">
                            ...
                            <p class="mb-6">Company Please enter your user information.</p>
                        </div>
                        <!-- Form -->
                        <form method='post'>
                            <!-- Username -->
                            <div class="mb-3">
                                ...
                                <input type="text" oninput="this.value = this.value.toUpperCase()" id="txtEmail" class="form-control" name="txtEmail"
                            ...
                            <br>
                            <a data-bs-target='#ForgotPasswordModal' data-bs-toggle='modal' href="#">Forgot Password</a><br />
                            <p class="message">Don't have an account? <a href="../CompanyRegistration.php">Sign Up</a></p>
                        </form>
                    </div>
                </div>
            </div>
    ...
    if (isset($_POST["btnLogin"]))
    {
        ...
        $Query = "Select * from companymaster where UserName='$Username' and Password='$Passwd'";
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <b>UserName</b><span style="color: red;" id="lblForgotUserName"></span>
            ...
            <div class="modal-footer">
                ...
                <?php
                    if (isset($_POST["btnForgot"]))
                    {
                        ...
                        $Query = "Select * from companymaster where Email='$Email'";
                        ...
                        if ($row = mysqli_fetch_assoc($res))
                        {
                            $Message = "Dear ".$row["CompanyName"]." Your Login Details are Username: ".$row["UserName"]." and Password: ".$row["Password"];
