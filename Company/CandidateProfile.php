...
<form class='p-3' method='post' id="app-content">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Are you sure to confirm in shortlist..!</h4>
				</div>
				<div class="modal-footer">
					<button type="submit" name='btnYes' id='btnYes' class="btn btn-success">Yes</button>
	...
	<?php
		...
		{
			$Query = "select * from shortlistmaster where CandidateId =".$_REQUEST["Id"]." and IpId=".$_REQUEST["IPId"];
				...
				justify-content-between pt-4 pb-6 px-4">
					<div class="d-flex align-items-center">
						<div class="lh-1">
							...
							<button data-bs-toggle='modal' data-bs-target='#confirmModal' type='button' class='btn btn-primary'>Add to Shortlist</button>
						</div>
					</div>
				</div>
			</div>
